            ...
            <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-2">
                ...
                {editingSubTask.history && editingSubTask.history.length > 0 ? (
                  editingSubTask.history.map((hist: any) => (
                    <div
                      key={hist.id}
                      className="p-3 border rounded-xl bg-slate-50 border-slate-100"
                    >
              ...
              <div className="space-y-2">
                ...
                {subTaskComments.map((comment: any) => (
                  ...
                  >
                    ...
                    {/* Add Feedback Input (only for admin/super_admin) */}
                    {!comment.feedback &&
                      (user?.role === "admin" ||
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-bold text-white transition-all bg-indigo-600 rounded-xl hover:bg-indigo-700"
                >
                  Send
                </button>
              </div>
