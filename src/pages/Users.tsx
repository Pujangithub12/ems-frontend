...
const Users: React.FC = () => {
  ...
  return (
    <div className="pb-12 space-y-6">
      ...
      {/* User Form Modal-like Inline */}
      {showUserForm && (
        <div className="overflow-hidden bg-white rounded-3xl border shadow-xl duration-200 border-slate-200 animate-in fade-in zoom-in-95">
